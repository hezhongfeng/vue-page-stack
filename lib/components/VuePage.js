  ...
  return defineComponent({
    ...
    setup(_props, { slots }) {
      ...
      const cacheSubtree = () => {
        ...
        console.log('cacheSubtree', stack);
      };
      ...
      return () => {
        ...
        if (history.action === config.backName) {
          console.log('开始还原 node', stack);
          // 还原的 node
          const cachedVNode = stack[stack.length - 2];
          ...
          // 被释放的 node
          const freedNode = stack.pop();
          resetShapeFlag(freedNode);
